...
let idCortes = buscaCortePorId(corteId);
let idBarba = buscaBarbaPorId(barbaId);

let pedido = {
    nome: nomeCliente,
    pedidoCorte: idCortes,
    pedidoCortePreco: idCortes.valor,
    pedidoBarba: idBarba,
    pedidoBarbaPreco: idBarba.valor
}
